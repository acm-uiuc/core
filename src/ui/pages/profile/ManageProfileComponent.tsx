...
export const ManageProfileComponent: React.FC<ManageProfileComponentProps> = ({
  ...
  const [userProfile, setUserProfile] = useState<
    undefined | null | UserProfileData
  >(undefined);
    ...
    <>
      {firstTime && (
        <Alert
          ...
          color="yellow"
        >
          Your profile is incomplete. Please provide us with the information
      ...
      <Box mx="auto" p="md">
        ...
        >
          ...
          <TextInput
            ...
            onChange={(e) =>
              setUserProfile(
                (prev) => prev && { ...prev, givenName: e.target.value },
              )
            }
          ...
          <TextInput
            ...
            onChange={(e) =>
              setUserProfile(
                (prev) => prev && { ...prev, surname: e.target.value },
              )
            }
          ...
          <TextInput
            ...
            onChange={(e) =>
              setUserProfile(
                (prev) => prev && { ...prev, mail: e.target.value },
              )
            }
